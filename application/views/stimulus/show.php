...
<div id="content" class="clearfix" style="width: 100%">
    ...
    <div style="padding-top: 10px">
        <div style="width:50%; display: inline-block">
            <?php
            $data = array($projects, $members);
            if(details['id'] == 54) {
                $this->load->view('stimulus/_hydrogen_map', array_merge($data, array('id' => $details['id'])));
            }
            else {
                $this->load->view('stimulus/_details_blue', array_merge($data, array('id' => $details['id'])));
            }
            ?>
        </div><!-- end #col1 -->
        ...
        <div style="width: 50%; float: right; height: 650px; overflow: scroll">
            ...
            <?php $this->load->view('stimulus/_projects_preview', array_merge($data, array('id' => $details['id'])));?>
        </div><!-- end #col2 -->
    </div>
