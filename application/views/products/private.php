...
<div class="pricing-container">
    <div class="pricing-header">
        <h1>COMPANY/INDIVIDUAL PARTNERSHIP</h1>
    ...
    <div class="pricing-content">
        <div class="column">
            <p class='service-row'><label class='label-brown'>Business Development</label>Bussiness opportunities
                presented and qualified, through algorithms that highlight projects of interest & updates</p>
            <p class='service-row'><label class='label-blue'>Project Analysis</label>Build your project win scenarios,
                by state - or by country - using GViP's developing data analyitics capacity</p>
            <p class='service-row'><label class='label-yellow'>Search Opportunities</label>Work with our data scientists
                to build algorithms to identify key potential clients, and the decisive win factors</p>
            <p class='service-row'><label class='label-iron'>Lead Qualification</label>Use our tools to see which
                projects are likely to move forward, & which are less so - measure against past sales success</p>
            <p class='service-row'><label class='label-green'>Proprietary Mapping</label>Build out - publicly or
            ...
            <p class='service-row'><label class='label-darkblue'>Audit Data Potential</label>Utilize GViP to build your
                data case - the value of your data, how to monetize - as an added resource for your company</p>
        </div>
        <div class="column">
            <p class='service-row'><label class='label-steel'>Direct Marketing</label>Have your products, skills and
                services highlighted directly to project decision makers - owners and bidders</p>
            <p class='service-row'><label class='label-purple'>Unique Analysis</label>Identify successful firms, project
                success features and critical strategies; Identify competitors - strengths/weaknesses</p>
            <p class='service-row'><label class='label-lightblue'>Global/Local Presence</label>Benefit from GViP as a
                global platform, and build the best possible local presence - especially partner ident</p>
            <p class='service-row'><label class='label-darkred'>24/7/365 Support</label>Dedicated account manager from
                the start, and also advice and support for anyone formally involved in a bid</p>
...
<div id="hider" class="hidden"></div>
<div id="popup_box" class="hidden" style="background-color: white">
    <a id="buttonClose">Close</a>
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">PURCHASE PARTNERSHIP</h3>
        ...
        <div class="panel-body">
            ...
            <form action="" method="POST" id="paymentFrm">
                ...
                <button type="submit" class="btn1 btn-success" id="payBtn">Submit Payment</button>
            </form>
        </div>
    </div>
</div>
