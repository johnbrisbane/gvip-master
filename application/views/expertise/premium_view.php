...
<a class="gviptv-banner__container" href="https://www.cg-la.com/store/p/gvip-annual-institutional-account-public-sector">
    <img src="https://d2huw5an5od7zn.cloudfront.net/skinny_banner.jpg" class="w-100 img-fluid">
</a>
        ...
        <div class="container-fluid">
            ...
            <div class="row mt-2">
                ...
                <div data-aos='zoom-in' class="col-md-6 header custom_scrollbar color">
                    ...
                    <div style="margin-top: 2em;" class="details row">
                        <div class="col-lg-4 social-details col-12 mx-auto ">
                            <h3 class="information__header-text">Contact</h3>
                            <div class="social">
                        ...
                        <div class="col-lg-4 social-details col-12 mx-auto">
                            <h3 class="information__header-text">Experts</h3>
                            <div class="social">
                                <p><?php echo empty($users['discipline']) ? '&mdash;' : $users['discipline'] ?></p>
                            </div>
                        </div>
                        <div class="col-lg-4 social-details  col-12 mx-auto">
                            <h3 class="information__header-text">Sector</h3>
                            <div class="social">
            ...
            <div class="row mt-2">
                ...
                <!-- Experts Section -->
                <div data-aos='zoom-in' class="col-lg-4 mx-auto mb-4  mt-2 color">
                ...
                <!-- If a scrollbar is needed,add overflow-y:scroll -->
                <div data-aos='zoom-in' class="col-lg-3 mx-auto mt-2 custom_scrollbar custom-margins color" style="height: 50em;">
