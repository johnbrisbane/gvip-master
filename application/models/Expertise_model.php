...
//echo '<pre>'; print_r($this->db->last_query()); echo '</pre>';
    ...
    public function get_books_specific($id){

        $qryexec = $this->db->get_where("exp_library",array("id" => $id));
        $execarr = $qryexec->row();
        $qryexec->free_result();

        $execarr->member_info = $this->find_photo($execarr->member_id);
    ...
    public function find_photo($id)
    {
        ...
        $row['registerdate'] = DateFormat($row['registerdate'], DATEFORMAT, FALSE);
