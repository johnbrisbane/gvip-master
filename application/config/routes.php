...
//Messageboard
$route['messageboard/create_category']	            = "messageboard/create_category";
$route['messageboard/(:any)']			            = "messageboard/category_view/$1";
$route['messageboard/(:any)/create_topic']	        = "messageboard/create_topic/$1";
$route['messageboard/delete_category/(:num)']	    = "messageboard/delete_category/$1";
$route['messageboard/delete_topic/(:num)']	        = "messageboard/delete_topic/$1";
$route['messageboard/delete_post/(:num)']	        = "messageboard/delete_post/$1";
$route['messageboard/(:any)/(:num)']	            = "messageboard/topic_view/$2";
$route['messageboard/(:any)/(:num)/create_post']	= "messageboard/topic_view/$2";
...
//Membership
$route['membership'] = "pages/index/membership";

// API
$route['api/experts/(:num)/forums/(:num)'] = "api/experts/forums/$1/$2";

// Images generated by Glide
$route[ltrim(IMAGE_RETRIEVAL_PATH, '/') . '/(:any)/(:any)'] = "images/show/$1/$2";

//Stripe
$route['make-stripe-payment'] = "StripePayment";
