...
class Projects extends CI_Controller {
	...
	*/
	public function edit($params)
	{
        ...
        $editdata['project']['energy'] = $this->projects_model->get_proj_energy_data($slug);
        $editdata['project']['water'] = $this->projects_model->get_proj_water_data($slug);
        $editdata['project']['transport'] = $this->projects_model->get_proj_transport_data($slug);
        $editdata['project']['IT'] = $this->projects_model->get_proj_IT_data($slug);
	...
	*/
	...
	public function algodev($id) {
        ...
        // load all members data from Members Model.
        $projectlist 	= 	$this->projects_model->get_projects_by_map($id);

        //collect data from database;
        $data	=	array(
            'main_content'	=>	'projects',
            'proj'				=>	$projectlist,
            'totalproj'			=>	count($projectlist)

        );
        // Render HTML Page from view direcotry
        $this->load->view("templates/header",$this->headerdata);
        $this->load->view("templates/leftmenu");
        $this->load->view('projects/projects_list_algo',$data);
        $this->load->view("templates/footer");
