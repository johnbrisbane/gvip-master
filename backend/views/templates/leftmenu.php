<div class="vernav2 iconmenu">
	...
	<ul>
        ...
        <li <?php if ($fst_segment == "maps") { echo "class='current'"; } ?>><a href="#mapsub" class="gallery">Maps</a>
            <span class="arrow"></span>
            <ul id="mapsub">
                <li <?php if ($fst_segment == "maps" && ($snd_segment == "index" || $snd_segment == "")) { echo "class='current'"; } ?>><a href="/admin.php/maps">View All</a></li>
                <li <?php if ($fst_segment == "maps" && $snd_segment == "create") { echo "class='current'"; } ?>><a href="/admin.php/maps/create">Add New Map</a></li>
            </ul>
        </li>
