<div class="centercontent">
    <div class="pageheader notab">
        <h1 class="pagetitle">Add New Map</h1>
        <span class="pagedesc">&nbsp;</span>
    </div>

    <div id="contentwrapper" class="contentwrapper">
        <?php echo form_open_multipart(current_url(), array('id' => "new_map_form")); ?>
            ...
            <div class="field">
                ...
                <div class="fld">
                    <?php echo form_input(array(
                        ...
                        'name'	=> 'title',
                        'placeholder' => 'Map title (e.g. Hydrogen Project Map)'
                    )); ?>
        ...
        <div>
        <?php
            echo form_submit('submit', 'Add New Map', 'class="light_green no_margin_left"');
            echo form_button('cancel', 'Cancel', 'class="light_gray no_margin_left" style="margin-left:10px;" onclick="window.location.href=\'/admin.php/maps\'"');
        ?>
        </div>
        <?php echo form_close(); ?>
    </div>
