...
define('MAPS_IMAGE_PATH', IMAGE_PATH.'/maps/');
define('MAPS_NO_IMAGE_PATH', IMAGE_PATH.'/site/');
define('MAPS_IMAGE_PLACEHOLDER', 'placeholder_project.jpg');
...
const INTERNAL_USERS = [24, 28, 37, 195, 198, 222, 298, 492, 562, 583, 684, 741, 813, 824, 840, 1138, 1301,
    1342, 1495, 1986, 3453, 3456, 3684, 3823, 3845, 3871, 3903, 3943, 3963, 4005, 4030, 4033, 4036, 4133, 4170, 4345, 4349, 4801];
...
const PREMIUM_COMPANIES = [4340, 4070, 4489, 4507, 4517, 4622, 4835];
