...
class Product extends CI_Model{
    ...
    function __construct() {
        $this->proTable   = 'exp_products';
        $this->ordTable = 'exp_orders';
    }
    ...
    public function getOrder($id){
        $this->db->select('r.*, p.title as product_name, p.price as product_price, p.currency as product_price_currency');
